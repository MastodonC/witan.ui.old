...
(def strings
  {:witan                          "Witan"
   ...
   :optional                       "(optional)"
   :sign-in                        "Sign In"
   :sign-up-token                  "Invite code"
   :name                           "Name"
   :create-account-header          "Need an account?"
   :create-account                 "Create Account"
   :create-account-info            "If you have an invite code you can create your account below:"
   :email                          "Email"
   ...
   :password-under-length          "The provided password is too short. Please make passwords at least 9 characters long."
