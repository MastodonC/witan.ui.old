...
STATUS=$(curl -s -o /dev/null -w "%{http_code}" -X POST http://52.28.251.86:9501/marathon/witan-ui -H "Content-Type: application/json" -H "x-kixi-keep-it-secret-keep-it-safe: 123" --data-binary "@witan-ui.json")
